...
def Bill(group, run):
    ...
    with open('/media/james/ext4data1/current/projects/ramasubbu/bootstrap_results_group_'+str(group)+'_run_'+str(run)+'.pickle', 'wb') as d: pickle.dump(bootstrap_results, d, pickle.HIGHEST_PROTOCOL) 
